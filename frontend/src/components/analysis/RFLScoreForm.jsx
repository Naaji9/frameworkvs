  ...
  return (
    <div className="max-w-6xl mx-auto p-8 bg-gradient-to-br from-purple-50 to-indigo-100 rounded-2xl shadow-2xl space-y-8 border-2 border-blue-800">
      ...
      <div className="text-center">
        ...
        <div className="mt-4 p-5 bg-gradient-to-r from-orange-50 to-red-50 border-2 border-red-700 rounded-xl shadow-lg">
          <p className="text-base font-bold text-gray-900 mb-3 flex items-center justify-center gap-2">
            <span className="text-2xl">⚠️</span> Installation Required
          </p>
      ...
      <button
        ...
        disabled={isWorking}
        className="w-full px-6 py-4 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white font-bold text-lg rounded-xl disabled:opacity-60 shadow-lg"
      >
